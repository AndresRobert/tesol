<div class="container users form">
    ...
    <?php else : ?>
    <h5 class="red-text">This person has not been registered</h5>
    <div class="input-field col s12 center-align">
        <button class="btn blue darken-4" onclick="window.open('/admin/registrations/register');">Register Now</button>
    </div>
    <?php endif; ?>
</div>
